...
('Balao_de_Ossos', 'Base_Do_Construtor'),
('Barbaro_Furioso', 'Base_Do_Construtor'),
('Bebe_Dragao_II', 'Base_Do_Construtor'),
('Bombardeiro', 'Base_Do_Construtor'),
('Bruxa_Sombria', 'Base_Do_Construtor'),
('Carrinho_de_Canhao', 'Base_Do_Construtor'),
('Gigante_Boxeador', 'Base_Do_Construtor'),
('P_E_K_K_A_Poderosa', 'Base_Do_Construtor'),
('Servo_Beta', 'Base_Do_Construtor'),
('Voador', 'Base_Do_Construtor'),
('Arqueira', 'Elixir'),
('Balao', 'Elixir'),
('Barbaro', 'Elixir'),
('Bebe_Dragao_I', 'Elixir'),
('Ciclope', 'Elixir'),
('Curadora', 'Elixir'),
('Destruidor_de_Muros', 'Elixir'),
('Dragao_Dirigivel', 'Elixir'),
('Dragao_Eletrico', 'Elixir'),
('Dragao', 'Elixir'),
('Gigante', 'Elixir'),
('Goblin', 'Elixir'),
('Golem_Meteoro', 'Elixir'),
('Mago', 'Elixir'),
('Mineiro', 'Elixir'),
('P_E_K_K_A', 'Elixir'),
('Poderosa_Hera', 'Elixir'),
('Tita_Eletrica', 'Elixir'),
('Yeti', 'Elixir'),
('Bruxa_das_Ruinas', 'Elixir_Negro'),
('Bruxa', 'Elixir_Negro'),
('Cacadora_de_Herois', 'Elixir_Negro'),
('Corredor', 'Elixir_Negro'),
('Druida', 'Elixir_Negro'),
('Fornalha', 'Elixir_Negro'),
('Golem_de_Gelo', 'Elixir_Negro'),
('Golem', 'Elixir_Negro'),
('Guardiao_Aprendiz', 'Elixir_Negro'),
('Lancador', 'Elixir_Negro'),
('Lava_Hound', 'Elixir_Negro'),
('Servo', 'Elixir_Negro'),
('Valquiria', 'Elixir_Negro'),
('Balao_Foguete', 'Supertropa'),
('Cao_de_Gelo', 'Supertropa'),
('Dragao_Infernal', 'Supertropa'),
('Goblin_Ardiloso', 'Supertropa'),
('Super_Yeti', 'Supertropa'),
('Superarqueira', 'Supertropa'),
('Superbarbaro', 'Supertropa'),
('Superbruxa', 'Supertropa'),
('Supercorredor', 'Supertropa'),
('Superdestruidor_de_Muros', 'Supertropa'),
('Superdragao', 'Supertropa'),
('Supergigante', 'Supertropa'),
('Superlancador', 'Supertropa'),
('Supermago', 'Supertropa'),
('Supermineiro', 'Supertropa'),
('Superservo', 'Supertropa'),
('Supervalquiria', 'Supertropa');
